<!-- source: docs_new/cookbook/autoregressive/Llama/Llama3.1.mdx -->
---
title: Llama-3.1
metatags:
...
For further details, please refer to the [Llama 3.1 blog](https://ai.meta.com/blog/meta-llama-3-1/) and the [Llama 3.1 model card](https://github.com/meta-llama/llama-models/blob/main/models/llama3_3_1/MODEL_CARD.md).note
...
- **FP8 Model Variants**:
  - 405B: Use Meta's official `meta-llama/Llama-3.1-8B-Instruct-FP8`
...
- **Quantization Guidance**:
  - BF16: Default high-precision format.
  - FP8: Optimized for throughput on supported CPUs.
  - W8A8: Highly optimized INT8 quantization for Xeon throughput.
- **Verified TP Configurations**:
  - 8B: Single socket (TP=1), Dual socket (TP=2)
  - 70B: Single socket (TP=1), Dual socket (TP=2)
  - 405B: Dual socket (TP=4)

# BF16
sglang serve meta-llama/Llama-3.1-8B --tp 1 --device cpu

# FP8
sglang serve meta-llama/Llama-3.1-8B-FP8 --tp 1 --device cpu

# W8A8
sglang serve RedHatAI/Meta-Llama-3.1-8B-Instruct-quantized.w8a8 --tp 1 --device cpu

# Dual-socket 70B BF16
sglang serve meta-llama/Llama-3.1-8B --tp 2 --device cpu

# Dual-socket 405B BF16
sglang serve meta-llama/Llama-3.1-8B --tp 4 --device cpu
